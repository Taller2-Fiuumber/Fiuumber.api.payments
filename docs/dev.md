...
```sh
$ http POST http://localhost:8082/wallet
HTTP/1.1 200 OK
...
$ http POST http://localhost:8082/deposit senderId=1 amountInEthers='0.01'
HTTP/1.1 200 OK
Connection: keep-alive
...
$ http GET http://localhost:8082/deposit/0x9f98447de34d3245ce1976956334336a6302befc4f204ac44a7cac0526caa82d
HTTP/1.1 200 OK
Connection: keep-alive
...
If you are running with problems with husky I recommend running:
